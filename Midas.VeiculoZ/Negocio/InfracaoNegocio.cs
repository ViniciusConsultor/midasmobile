...
{
    public class InfracaoNegocio:NegocioGenerico,IInfracaoNegocio
    {
        public InfracaoNegocio()
        {
            this.AcessoDados = new Dados.SQLServer.InfracaoDados();
        }

        #region IInfracaoNegocio Members

        public System.Collections.IList ListarInfracoesPorClassificacaoDescricao(long id, string descricao)
        {
